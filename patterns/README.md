...
2. Scaffold with `npx @kevinzhangnothing/loop-init . --pattern <name> --tool grok` (or `--tool opencode` / `--tool claude`) or copy from `starters/`
...
6. Audit with `npx @kevinzhangnothing/loop-audit . --suggest`
