...
```bash
npx @kevinzhangnothing/loop-cost --pattern <id> --level L1
npx @kevinzhangnothing/loop-init . --pattern daily-triage --tool grok   # scaffolds loop-budget.md + loop-run-log.md
```
