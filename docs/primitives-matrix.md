...
Loops discover ongoing work; **goals finish bounded tasks**. Canonical reference: **[Goal Engineering](./concepts.md)** (`/goal`, `update_goal`, `GOAL.md`, `goal-verifier`).
...
| Goal vs loop decision | [goal-vs-loop.md](#goals-run-until-done) |
