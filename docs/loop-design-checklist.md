...
- [ ] Bot identity clear on PR comments (e.g. "Agent Loops — PR Babysitter")

## 8. Cost & Limits

- [ ] **Token budget** estimated (`npx @kevinzhangnothing/loop-cost`, [operating-loops.md](./operating-loops.md))
