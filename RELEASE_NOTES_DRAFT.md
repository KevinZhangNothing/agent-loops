...
|---------|---------|-------|
| `@kevinzhangnothing/loop-worktree` | **1.0.0** | New — `loop-worktree-v1.0.0` |
| `@kevinzhangnothing/loop-mcp-server` | 1.0.0 | No change |
| `@kevinzhangnothing/loop-audit` | 1.5.3 | No change |
| `@kevinzhangnothing/loop-init` | 1.3.3 | No change |
| `@kevinzhangnothing/loop-cost` | 1.0.3 | No change |
| `@kevinzhangnothing/loop-sync` | 1.0.0 | No change |
| `@kevinzhangnothing/loop-context` | 1.0.0 | No change |
