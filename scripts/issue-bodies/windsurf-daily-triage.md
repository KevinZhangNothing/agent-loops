...
- [ ] Map scheduling to Cascade **Workflows** (`/workflow-name`) per [primitives-matrix appendix](https://github.com/KevinZhangNothing/agent-loops/blob/main/docs/primitives-matrix.md#appendix-editor-transfer-recipes-opencode-cursor--windsurf)
