...
- [ ] Map scheduling to Cursor **Automations** or Agent chat (see [primitives-matrix appendix](https://github.com/KevinZhangNothing/loop-engineering/blob/main/docs/primitives-matrix.md#appendix-editor-transfer-recipes-opencode-cursor--windsurf))
