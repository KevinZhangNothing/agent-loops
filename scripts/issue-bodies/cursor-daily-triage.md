...
- [ ] Map scheduling to Cursor **Automations** or Agent chat (see [primitives-matrix appendix](https://github.com/KevinZhangNothing/agent-loops/blob/main/docs/primitives-matrix.md#appendix-editor-transfer-recipes-opencode-cursor--windsurf))
