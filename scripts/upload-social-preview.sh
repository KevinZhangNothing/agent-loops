...
SETTINGS_URL="https://github.com/KevinZhangNothing/agent-loops/settings"

if [[ ! -f "${IMAGE}" ]]; then
  echo "Missing ${IMAGE}"
  echo "Regenerate with:"
  echo "  sips -c 640 1280 assets/visuals/agent-loops-social-banner.jpg --out assets/visuals/social-preview.jpg"
  exit 1
fi
